...
class ChatRoom extends Component {
    ...
    render() {
        ...
        if (this.props.chatrooms) {
            list = this.props.chatrooms.map(chatroom => <Room key={chatroom.chatroomId} chatroomId={chatroom.chatroomId} roomName={chatroom.roomName} lastchat={chatroom.lastchat} onClick={this.handleClick}/>);
        }
